    ...
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto bg-gray-100 border-gray-200 p-6 rounded-xl">
            ...
            <form method="post" action="/{{ route('register') }}" class="mt-10">
                <div class="mb-6">
                    <label class="block mb-6 text-uppercase font-bold text-xs text-gray-700" for="username">
                        username
                    </label>
                ...
                <div class="mb-6">
                    <label class="block mb-6 text-uppercase font-bold text-xs text-gray-700" for="password_confirmation">
